            ...
            <View style={{flex: 1, flexDirection: 'column', backgroundColor: 'rgba(0,0,0,0.5)'}}>
                ...
                <View style={{flex: 0.3, flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center', backgroundColor: theme.background_color, borderTopLeftRadius: 30, borderTopRightRadius: 30, paddingBottom: 30, paddingTop: 10}}>
                    <View style={{width: '100%', height: '30%', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingLeft: '38%'}}>
                        <Text style={{fontSize: 30, fontWeight: 600, color: theme.contrast_text_color}}>{t['Speed']}</Text>
                        <TouchableOpacity
                    ...
                    <Text style={{fontSize: 20, fontWeight: 500, alignSelf: 'center', color: theme.contrast_text_color}}>
                        {tempSpeed === 1 ? t['Slow'] : tempSpeed === 3 ? t['Normal'] : t['Fast']}
                    </Text>
                    <View style={{flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginTop: 20}}>
                        <Text style={{fontSize: 15, fontWeight: 500, color: theme.contrast_text_color}}>{t['Slow']}</Text>
                        <Slider
                        ...
                        />
                        <Text style={{fontSize: 15, fontWeight: 500, color: theme.contrast_text_color}}>{t['Fast']}</Text>
                    </View>
                    <TouchableOpacity 
                    ...
                    >
                        <Text style={{fontSize: 20, fontWeight: 500, color: theme.secondary_color}}>Apply</Text>
                    </TouchableOpacity>
                </View>
            </View>
        </Modal>
